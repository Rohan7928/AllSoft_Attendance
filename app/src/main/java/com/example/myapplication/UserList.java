...
import com.example.myapplication.parser.JSONParser;
import com.example.myapplication.util.InternetConnection;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Snackbar.make(findViewById(R.id.parentLayout), list.get(position).getName() + " => " + list.get(position).getLocation()+ " => " + list.get(position).getTime(), Snackbar.LENGTH_LONG).show();
            }
        });
                    ...
                    if(jsonObject.length() > 0) {
                        ...
                        if(lenArray > 0) {
                            for( ; jIndex < lenArray; jIndex++) {
                                ...
                                String mobile=innerObject.getString(Keys.KEY_MOBILE);
                                String type=innerObject.getString(Keys.KEY_TYPE);
                                String address=innerObject.getString(Keys.KEY_ADDRESS);
                                String image = innerObject.getString(Keys.KEY_PHOTO);
                                /**
